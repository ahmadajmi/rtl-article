...
The Sass task takes two files one for `ltr-app.scss` and `rtl-app.scss` and generate the CSS files from them.
...
We can include these variables in external files, but this is just for keeping things more clear and give you the idea.
